...
┠➽ *#gifsticker [link giphy]*
┠➽ *#ask [pertanyaan]*
┠➽ *#ara [gabut parah]*
┠➽ *#neko [foto kucing]*
┠➽ *#inu [foto anjing]*
┠➽ *#pokemon [foto pokemon]*
┠➽ *#dadu [nomor dadu acak]*
┠➽ *#translate [kode] [teks]*
┠➽ *#tts [ubah teks jadi suara]*
┠➽ *#lirik [menampilkan lirik lagu]*
┠➽ *#ptl [penyegaran pria]*
┠➽ *#wallpaper [free wallpaper]*
┠➽ *#rmeme [random meme]*
┠➽ *#koin [buat menentukan]*
 ╿
 ┷[ Downloader Commands ]
 ╿
┠➽ *#ytmp4 [linkvideo]*
...
┠➽ *#wallanime [wallpaper]*
┠➽ *#qanime [quotes anime]*
┠➽ *#waifu [foto waifu random]*
┠➽ *#husbu [foto husbu random]*
┠➽ *#fetish [cari tau aja sendiri]*
╿
┷┯[ Other Commands ]
╿
┠➽ *#quotes [random quotes]*
┠➽ *#resi [nama jasa] [no resi]*
┠➽ *#news [menampilkan berita]*
┠➽ *#ceklokasi [cek lokasi covid]*
┠➽ *#wallpaper [free wallpaper]*
...
┠➽ *#demote @tagadmin*
┠➽ *#bye [bot keluar]*
┠➽ *#del [reply pesan bot lalu ketik]*
┠➽ *#adminlist [nomor admin]*
┠➽ *#ownergrup [nomor owner]*
┠➽ *tagall [tag seluruh member]*

➨Ketik *#readme* untuk melihat tutorial.
➨ Ketik *#rules* untuk melihat rules.
